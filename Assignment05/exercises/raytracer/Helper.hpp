#ifndef _HELPER_HPP_INCLUDE_ONCE
#define _HELPER_HPP_INCLUDE_ONCE
...
public:
  ...
  */
  ...
  RAYTRACER_EXPORTS static bool Helper2(const Ray& ray, const Vec3d &a, const Vec3d &b, const Vec3d &c, Vec3d& uvw, double & lambda)
  {
    if(!Helper1(ray,a,b,c,uvw,lambda))
      return false;
...
#endif // _HELPER_HPP_INCLUDE_ONCE